    ...
    <section class="py-5">
      <div class="container">
        <div class="text-center mb-5">
          <h1 class="display-4 fw-bold mb-4">Go Solar. Save Big. Get Matched with Trusted Installers</h1>
          <p class="lead fs-6 text-muted mb-4 mx-auto" style="max-width: 800px;">
        ...
        <div class="mb-5">
          <div class=" overflow-hidden">
            <img src="https://cdn-assets-us.frontify.com/s3/frontify-enterprise-files-us/eyJwYXRoIjoic3VucnVuXC9maWxlXC9EbzZqOFVMY1JiSEtDYXNQQmNmSi5qcGcifQ:sunrun:tAHXMLcRVBx-8FymD7oQMYwMxW2HYF40Udl8mDVrQC0?width=1440&format=webp" alt="Solar Farm Aerial View" 
    ...
    <section id="faqs" class="py-5 bg-light">
      <div class="container">
        <div class="row justify-content-between align-items-start g-5">
          ...
          <div class="col-lg-4">
            <h2 class="display-6 mt-2 mb-4 lh-sm fw-normal">Everything you need to know about going solar — answered.</h2>
          </div>
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-lg-6 pe-lg-5">
            <h2 class="display-6 mt-2 mb-4 lh-sm fw-normal">Your home energy, customized</h2>
    ...
    <section class="py-5">
      <div class="container">
        <div style="max-width: 400px">
          <h2  class="display-6 mt-2 mb-4 lh-sm fw-normal">Easy Process. Happy Customers.</h2>
        </div>
